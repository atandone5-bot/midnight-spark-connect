  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex items-center justify-center rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 transition"
        >
          Go home
        </Link>
      </div>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "After Dark — Private meetups, after hours" },
